...
--*/
{
    ...
    info1( "RoboDeviceEvtDeviceD0Entry - coming from %s\n", DbgDevicePowerString(RecentPowerState) );

    return STATUS_SUCCESS;
}

NTSTATUS
RoboDeviceEvtDeviceD0Exit(
    IN WDFDEVICE                Device,
...
--*/
{
    ...
    info1( "RoboDeviceEvtDeviceD0Exit %s\n", DbgDevicePowerString(PowerState) );

    return STATUS_SUCCESS;
}

NTSTATUS
RoboDeviceEvtDeviceArmWakeFromS0(
    IN WDFDEVICE Device
    )
/*++
...
--*/
{
    ...
    info0( "--> RoboDeviceEvtDeviceArmWakeFromS0\n" );

    return STATUS_SUCCESS;
}

NTSTATUS
RoboDeviceEvtDeviceArmWakeFromSx(
    IN WDFDEVICE Device
    )
/*++
...
--*/
{
    ...
    info0( "--> RoboDeviceEvtDeviceArmWakeFromSx\n" );

    return STATUS_SUCCESS;
}

VOID
RoboDeviceEvtDeviceDisarmWakeFromS0(
    IN WDFDEVICE Device
    )
/*++
...
--*/
{
    ...
    info0( "--> RoboDeviceEvtDeviceDisarmWakeFromS0\n" );

    return ;
}

VOID
RoboDeviceEvtDeviceDisarmWakeFromSx(
    IN WDFDEVICE Device
    )
/*++
...
--*/
{
    ...
    info0( "--> RoboDeviceEvtDeviceDisarmWakeFromSx\n" );

    return ;
}

VOID
RoboDeviceEvtDeviceWakeFromS0Triggered(
    IN WDFDEVICE Device
    )
/*++
...
--*/
{
    ...
    info0( "--> RoboDeviceEvtDeviceWakeFromS0Triggered\n" );

}

VOID
RoboDeviceEvtDeviceWakeFromSxTriggered(
    IN WDFDEVICE Device
    )
/*++
...
--*/
{
    ...
    info0( "--> RoboDeviceEvtDeviceWakeFromSxTriggered\n" );
